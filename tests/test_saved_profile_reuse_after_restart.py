...
from aethos_core.runtime.vercel_readonly_jobs import resolve_vercel_profile_for_chat
...
def test_persistent_profile_reused_after_store_recreate(isolated_profiles_dir):
