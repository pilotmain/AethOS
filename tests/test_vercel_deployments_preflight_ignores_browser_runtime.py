...
def test_deployments_preflight_ready_with_api_token_and_broken_browser():
    ...
    assert derive_preflight_status(outcome.preflight) != "blocked"
    assert outcome.preflight.target_name == "quotepilot"
