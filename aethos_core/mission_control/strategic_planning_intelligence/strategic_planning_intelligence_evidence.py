...
"""FIX 326 — composed strategic planning evidence."""
...
def collect_strategic_planning_evidence(*, session_id: str = "default") -> dict[str, Any]:
    ...
    bundle["planning_review_records"] = [
        r for r in list_planning_review_records() if not sid or str(r.get("session_id") or sid) == sid
    ]
