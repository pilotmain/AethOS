...
"""Generate WORKSTREAM_C2 delivery optimization deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_C2 — delivery optimization program")
    ...
    result = build_delivery_optimization_program(session_id=args.session_id)
    board = result.delivery_optimization_program
