...
"""Generate WORKSTREAM_F3 multi-customer value proof deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_F3 — multi-customer value proof")
    ...
    result = build_multi_customer_value_proof_program(session_id=args.session_id)
    board = result.multi_customer_value_proof_program
