...
"""Generate WORKSTREAM_H2 governed strategic execution deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_H2 — governed strategic execution")
    ...
    result = build_governed_strategic_execution_program(session_id=args.session_id)
    board = result.governed_strategic_execution_program
