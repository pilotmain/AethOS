...
"""Generate PHASE_I2 governed autonomous execution proof deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="PHASE_I2 — governed autonomous execution proof")
    ...
    result = build_governed_autonomous_execution_proof_program(session_id=args.session_id)
    board = result.governed_autonomous_execution_proof_program
