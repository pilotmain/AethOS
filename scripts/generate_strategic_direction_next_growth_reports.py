...
"""Generate WORKSTREAM_H1 strategic direction & next-growth decision deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_H1 — strategic direction & next-growth decision")
    ...
    result = build_strategic_direction_next_growth_decision_program(session_id=args.session_id)
    board = result.strategic_direction_next_growth_decision_program
