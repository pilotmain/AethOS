...
"""Generate WORKSTREAM_F4 customer scale validation deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_F4 — customer scale validation")
    ...
    result = build_customer_scale_validation_program(session_id=args.session_id)
    board = result.customer_scale_validation_program
