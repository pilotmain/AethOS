...
"""Generate WORKSTREAM_E1 intelligence performance deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_E1 — intelligence performance & evidence scalability")
    ...
    result = build_intelligence_performance_evidence_scalability_program(session_id=args.session_id)
    board = result.intelligence_performance_evidence_scalability_program
