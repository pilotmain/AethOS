...
"""Generate WORKSTREAM_D2 multi-cloud operational proof deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_D2 — multi-cloud operational proof")
    ...
    result = build_multi_cloud_operational_proof_program(session_id=args.session_id)
    board = result.multi_cloud_operational_proof_program
