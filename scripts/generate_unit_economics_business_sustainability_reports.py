...
"""Generate WORKSTREAM_F6 unit economics & business sustainability deliverables."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="WORKSTREAM_F6 — unit economics & business sustainability")
    ...
    result = build_unit_economics_business_sustainability_program(session_id=args.session_id)
    board = result.unit_economics_business_sustainability_program
